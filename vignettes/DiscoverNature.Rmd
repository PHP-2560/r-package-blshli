...
To do this, the user will need to input both a title and resulting tibble from a *explore_keyword* or *explore_subject* search as shown in the code. The explore_paper call searches for the title within the saved search and opens passes the appropriate url to the browseURL( )
